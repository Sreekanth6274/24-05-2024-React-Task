...
const Lorem = ()=> {
  ...
  <div>
    <div> 
    <h1 className='text-center font-monospace '>Lorem Ipsum</h1>
    <Container>
  ...
  <Row>
    <Col>
    <h3 className=' font-monospace '>What is Lorem Ipsum?</h3>
    ...
    <Col>
    <h3 className=' font-monospace '>Why do we use it?</h3>
  ...
  <Row>
    <Col className="mb-3">
    <h3 className=' font-monospace '>Where does it come from?</h3>
    ...
    <Col className="mb-3" >
    <h3 className=' font-monospace '>Where can I get some?</h3>
    ...
    <p style={{borderTop: "1px solid black" , borderBottom: "1px solid black", textAlign:"center"}}>
